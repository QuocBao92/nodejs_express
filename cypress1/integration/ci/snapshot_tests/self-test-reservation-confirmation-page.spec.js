describe("Snapshot-testing: Self Test Reservation Confirmation", () => {
  const viewports = [
      ...
      fixtures.forEach((fixture) => {
        it(`Case: ${fixture} data`, () => {
          ...
          cy.server()
            ...
            .as("getLocations");
          cy.visit(Cypress.env("selfTestNew")).wait(["@getAssets", "@getTypes", "@getRegions", "@getCustomers"], { requestTimeout: 10000 });
          cy.wait(1000);

let apiTasks, apiTasksLogsId, logsEdit, logsEditConfirm;
...
describe("Page-Log Reservation Edit Confirmation", () => {
        ...
        .then((api) => {
          ...
          cy.get("bridge-log-reservation-edit-page")
            ...
            .then(() => {
              ...
              cy.get("bridge-log-reservation-edit-confirmation-page")
                              ...
                              cy.get("bridge-button")
                                ...
                                .then(() => {
                                  cy.root()
                                    ...
                                    .find("mat-dialog-container bridge-alert")
                                    .should("not.exist");
                                  cy.location("href").should("eq", Cypress.config("baseUrl") + Cypress.env("logsEditConfirm"));
                                });
                            });
                        });
                    });

...
describe("Page-Self Test Reservation Edit Confirmation", () => {
  ...
  context("initial display", () => {
    it("initial display", () => {
      ...
      cy.visit(Cypress.env("selfTestEdit"))
        .wait(["@apiAssets", "@apiTasksSelfTestsId"])
        .then((api) => {
          ...
          cy.get("bridge-self-test-reservation-edit-page")
            ...
            .then(() => {
              ...
              cy.get("bridge-self-test-reservation-edit-confirmation-page")
                              ...
                              cy.get("bridge-button")
                                ...
                                .then(() => {
                                  cy.root()
                                    ...
                                    .find("mat-dialog-container bridge-alert")
                                    .should("not.exist");
                                  cy.location("href").should("eq", Cypress.config("baseUrl") + Cypress.env("selfTestEditConfirm"));
                                });
                            });
                        });
                    });
